...
4. Elite fight relics, and a shop's first two relic slots. Grouped because they're held up by the same thing: both depend on your route, which the app doesn't model yet.
